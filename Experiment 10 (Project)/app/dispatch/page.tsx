...
export default function DispatchLog() {
  ...
  const handleAddDispatch = () => {
    ...
    const dispatch = {
      ...
      revenue: Number.parseInt(newDispatch.revenue) || 0,
      ...
      <header className="relative z-10 flex h-20 shrink-0 items-center gap-2 border-b border-white/20 bg-white/80 backdrop-blur-sm px-6">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl">
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              <Button onClick={handleAddDispatch} className="w-full">
                Create Dispatch
              </Button>
            </div>
          </DialogContent>
