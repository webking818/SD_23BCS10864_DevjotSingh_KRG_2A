...
export default function Attendance() {
  ...
  const handleMarkAttendance = () => {
    ...
    const punchOutTime = newAttendance.punchOut ? new Date(`2024-01-01 ${newAttendance.punchOut}`) : null
    const hoursWorked = punchOutTime ? (punchOutTime.getTime() - punchInTime.getTime()) / (1000 * 60 * 60) : 0
    ...
    const attendance = {
      ...
      status: hoursWorked >= 8 ? "Present" : hoursWorked >= 4 ? "Half Day" : "Present",
      department: newAttendance.department,
    }

    setAttendanceRecords([...attendanceRecords, attendance])
    setNewAttendance({ employeeId: "", employeeName: "", punchIn: "", punchOut: "", department: "" })
      ...
      <header className="relative z-10 flex h-20 shrink-0 items-center gap-2 border-b border-white/30 bg-white/90 backdrop-blur-sm px-6 shadow-sm">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button className="bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl text-white font-bold">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewAttendance({ ...newAttendance, department: value })}
                >
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewAttendance({ ...newAttendance, punchIn: e.target.value })}
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewAttendance({ ...newAttendance, punchOut: e.target.value })}
                  />
                </div>
              </div>
